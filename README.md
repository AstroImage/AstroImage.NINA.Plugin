...
`inizio` e `fine` è un *inviluppo*, non una finestra piena: va dal primo all'ultimo
istante in cui il soggetto sta sopra la soglia di altezza, e in mezzo ci può essere un tratto in cui il
