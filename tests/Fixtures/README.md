...
Questi JSON **non sono scritti a mano**. Sono usciti dal motore di
...
motore le rigenera facendolo girare sui casi
...
| file | da dove viene |
|---|---|
| `profilo-osc.json` | generata dal file `.profile` **vero** di N.I.N.A. su questa macchina: focale 800, f/6.9, pixel 3,76 µm, matrice RGGB, sito 45,95 / 10,2 a 1000 m, guadagno 100, offset 50 |
