...
namespace AstroImage.NINA.Plugin.Tests.Montaggio {
    ...
    public class CambioDiProfiloTests {
         ...
         *  la geometria dal driver, la voce riconosciuta —: collegarne o scollegarne una cambia il banco senza un
         *  salvataggio, e la prescrizione in mano era calcolata sull'altro. Il pannello ascolta gli eventi del mediatore
