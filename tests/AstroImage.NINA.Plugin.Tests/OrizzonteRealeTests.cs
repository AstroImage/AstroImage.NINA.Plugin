...
namespace AstroImage.NINA.Plugin.Tests {
     ...
     *      in tutte le direzioni. Con una montagna e una valle vuol dire regalare ore
    ...
    public class OrizzonteRealeTests {
        ...
        /*  Un profilo sintetico, un punto ogni quindici gradi: una montagna di 41 gradi a
         *  nord-est e una valle di 8 a sud, la forma che queste prove guardano. Il
         *  profilo vero di chi riprende sta nel suo N.I.N.A., e qui non si pubblica. */
        private static double[][] ProfiloSintetico() => new[] {
            new[] {   0d, 36.3 }, new[] {  15d, 38.6 }, new[] {  30d, 41.0 }, new[] {  45d, 37.7 },
            new[] {  60d, 34.4 }, new[] {  75d, 31.1 }, new[] {  90d, 27.8 }, new[] { 105d, 24.5 },
            new[] { 120d, 21.2 }, new[] { 135d, 17.9 }, new[] { 150d, 14.6 }, new[] { 165d, 11.3 },
            new[] { 180d,  8.0 }, new[] { 195d, 10.4 }, new[] { 210d, 12.7 }, new[] { 225d, 15.1 },
            new[] { 240d, 17.4 }, new[] { 255d, 19.8 }, new[] { 270d, 22.1 }, new[] { 285d, 24.5 },
            new[] { 300d, 26.9 }, new[] { 315d, 29.2 }, new[] { 330d, 31.6 }, new[] { 345d, 33.9 },
        };
        ...
        public void IlProfiloArrivaINTERO_ENonRidotto() {
            var s = DichiarazioneSito.Unisci(DaNina(ProfiloSintetico()), new SitoDichiarato { Sqm = 20.8 });
        ...
        public void OgniPuntoPortaIlSuoAzimut() {
            var s = DichiarazioneSito.Unisci(DaNina(ProfiloSintetico()), new SitoDichiarato());
        ...
        public void LOrizzonteNonSiDichiara() {
            ...
            var s = DichiarazioneSito.Unisci(DaNina(ProfiloSintetico()), new SitoDichiarato { HorizonMin = 20 });
        ...
        public void IlProfiloSopravviveAlFilo() {
            var s = DichiarazioneSito.Unisci(DaNina(ProfiloSintetico(), @"C:\Users\x\Sito di prova .hrz"),
            ...
            Assert.AreEqual(@"C:\Users\x\Sito di prova .hrz", torna.OrizzonteFile);
        }
