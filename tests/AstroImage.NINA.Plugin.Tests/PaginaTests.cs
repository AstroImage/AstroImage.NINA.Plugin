...
namespace AstroImage.NINA.Plugin.Tests {
    ...
    public class PaginaTests {
        ...
        public void LA_PENALIZZAZIONE_LUNARE_SI_SCRIVE_IN_TRE_PARTI() {
            ...
            /*  IL MOLTIPLICATORE IN EVIDENZA (regia, 17 settembre 2026): la soglia ha un tetto, e L-Ultimate, L-eNhance, LRGB e
             *  IDAS stanno tutti a 120°; per i filtri larghi il numero che distingue e' il moltiplicatore, e si legge per primo. */
         ...
         *  ha diciassette: con la camera scollegata, chi riprende scrive nome, matrice, pixel, larghezza e altezza, e se li
