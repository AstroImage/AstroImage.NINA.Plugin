...
namespace AstroImage.NINA.Plugin.Tests {
    ...
    public class RegoleDelPonteTests {
        ...
        public void IlPonteNONImponeIlDither_MaSaToglierloSenzaGuida() {
             ...
             *  una prescrizione.
             *
             *  NON LO E'. Nel motore `ditherEvery` sta fra i valori OPERATIVI
             *  dell'utente, con un valore di serie: il motore lo legge, non lo calcola.
             ...
             *
             *  E lo scarto sta dentro il margine: il piano toglie gia' un margine a ogni
