...
namespace AstroImage.NINA.Plugin.Services {
    ...
    public sealed class PrescrizioneCorrente {
         ...
         *  Rifiutare una consegna sarebbe una decisione, e il Ponte consegna, non amministra — la stessa regola per cui non
         *  calcola. Qui non si tiene nessun conto delle notti consegnate. */
