...
namespace AstroImage.NINA.Plugin.Services {
     ...
     *
     *  IL SERVIZIO LA ACCETTA GIA', fra le opzioni della
     *  domanda (`filterNames`): una mappa passata cosi'
     *  sovrascrive i nomi di serie. Non c'era niente da inventare — solo da
