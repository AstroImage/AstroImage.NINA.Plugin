...
namespace AstroImage.NINA.Plugin.Services {
    ...
    public static class DichiarazioneSito {
        ...
        public static SitoDiRipresa Unisci(SitoDiRipresa? letto, SitoDichiarato? dichiarato) {
             ...
             *  nasconde meta' cielo, il minimo fa riprendere dentro la casa. Con una
             *  montagna da un lato solo, fra il minimo e il massimo corre un fattore due
             *  di ore su un oggetto da quella parte.
             *
