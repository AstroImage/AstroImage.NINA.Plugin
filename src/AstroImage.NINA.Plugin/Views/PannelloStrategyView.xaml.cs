    ...
    public partial class PannelloStrategyView : UserControl {
        ...
        private async void AlMessaggio(object mittente, CoreWebView2WebMessageReceivedEventArgs e) {
            ...
            try {
                 ...
                 *  quel caso usava la sua ruota di serie: il motore calcolava sui
                 ...
                 *  equipaggiamento, e non lo era. E la ruota vera non e' cosmetica: decide
        ...
        private async Task Modalita(string id) {
             ...
             *
             *  Il motore i suoi modi li dichiara sempre — e' nel contratto della porta —
