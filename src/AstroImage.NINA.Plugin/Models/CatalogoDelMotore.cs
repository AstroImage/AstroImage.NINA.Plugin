...
namespace AstroImage.NINA.Plugin.Models {
    ...
    public sealed class VetroDelMotore {
        ...
        /// non tutti coprono le stesse due bande.</summary>
        [JsonPropertyName("bande")] public List<string>? Bande { get; set; }

        [JsonPropertyName("dual")] public bool Dual { get; set; }

        /*  TRE STATI E NON DUE. `null` vuol dire «non si sa», e non va arrotondato a
         *  «no»: arrotondarlo nasconderebbe, a chi filtra per camera, ogni vetro per
         *  cui non e' dichiarato. */
